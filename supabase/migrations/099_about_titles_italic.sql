-- 099_about_titles_italic.sql
--
-- Wraps each team member's title in *italics* so the renderer emits
-- <em>...</em> inside the h3. The corresponding CSS update in
-- src/app.css renders h3 italics as muted-grey, so the name visually
-- pops above the title.
